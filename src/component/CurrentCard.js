        ...
        return (
            ...
            className = "pa2 ma3 br3 dib bg-lightest-blue bw2 shadow-2 mw8 center ph3-ns" >
                <div className = "main tc fl w-100 w-third-ns pa2" >
                    < img className="Ccardimg" src={`http://openweathermap.org/img/wn/${weather.CWeatherIcon}@2x.png`} alt="weather_icon" />
                    <h2 className="sub-text tc">{weather.CWeatherMain}<br />
                    ...
                    <h3>Last Update at: {converter(weather.LastUpdate) + " "}   <FontAwesomeIcon className="grow pointer" onClick={func} icon={faSyncAlt} size="xs" /></h3>
                </div>
                ...
                <div className = "para-text fl w-100 w-third-ns pa2" >
                    ...
                    <div className="col3 row2">
                        ...
                        <div>Current day Sunrise: {converter(weather.CDaySunrise)}</div>
                        <div>Current day Sunset: {converter(weather.CDaySunset)}</div>
                    </div>
                </div>
            </div>
        );
